...
public class Database {
    ...
    // FILTER, 2
    void filterWithTwoFields(String collectionName, String field1, Object filter1, String field2, Object filter2,
            Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
    ...
    // FILTER, 3
    void filterWithOneFieldAndCompareGreater(String collectionName, String field1, Object filter1, String field2,
            Object filter2, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
    ...
    // FILTER, 4
    void filterWithOneFieldAndCompareLess(String collectionName, String field1, Object filter1, String field2,
            Object filter2, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
    ...
    // FILTER, 7
    void compareLessOrderBy(String collectionName, String field, Object filter, String orderField, Query.Direction dir,
            Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereLessThan(field, filter)
    ...
    // FILTER, 8
    void compareGreaterThanOrderBy(String collectionName, String field, Object filter, String orderField,
            Query.Direction dir, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereGreaterThan(field, filter)
                .orderBy(orderField, dir);
        query(q, className, resultCode);
    ...
    // FILTER, 3
    void filterWithOneFieldAndCompareGreaterOrder(String collectionName, String field1, Object filter1, String field2,
            Object filter2, String orderField, Query.Direction dir, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
                .whereGreaterThan(field2, filter2)
                .orderBy(orderField, dir);
    ...
    // FILTER, 4
    void filterWithOneFieldAndCompareLessOrder(String collectionName, String field1, Object filter1, String field2,
            Object filter2, String orderField, Query.Direction dir, Class<?> className, int resultCode) {
        Query q = db.collection(collectionName)
                .whereEqualTo(field1, filter1)
                .whereLessThan(field2, filter2)
    ...
    // void filterWithTwoFieldsWithinRangeOrder(String collectionName, String
    // field1, Object filter1,
    // String field2, Object filter2, String orderField, Query.Direction dir,
    // Class<?> className, int resultCode) {
    // Query q = db.collection(collectionName)
