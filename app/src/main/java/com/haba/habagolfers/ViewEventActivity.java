...
import static com.haba.habagolfers.UserDiscoverFragment.getTodayDate;
...
public class ViewEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this,
                "pk.eyJ1Ijoic3QzdjNubXciLCJhIjoiY2s3bHh5OG42MGM1aDNrcDZyNXlkZXB2NCJ9.QjrMAZJvETZJAQHC8-0tsw");
        ...
        final Event event = new Event(addedBy, attendeeCount, checkInCount, new Timestamp(end, 0), image, location,
                name, orgId, true, new Timestamp(start, 0), type, coordinates);
        ...
        if (event.end.getSeconds() < getTodayDate().getTime() / 1000L)
            countView.setText(event.attendeeCount + " went");
                ...
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        mapboxMap.addMarker(new MarkerOptions()
                                .position(new LatLng(event.coordinates.get("latitude"),
                                        event.coordinates.get("longitude")))
                                .icon(IconFactory.getInstance(ViewEventActivity.this)
        ...
        db = new Database(new AsyncResponse() {
                ...
                if (resultCode == 0) {
                    if (result.isEmpty()) {
                        ...
                        book.setOnClickListener(v -> {
                            if (event.end.getSeconds() < getTodayDate().getTime() / 1000L) {
                                Toast.makeText(getApplicationContext(), "The deadline to book has passed",
            ...
            public void resultHandler(String msg, int resultCode) {
                if (resultCode == 1) {
                    ...
                    db.filterWithTwoFields("tickets", "userId", mAuth.getUid(), "eventId", event.eventId, Ticket.class,
                            0);
