...
public class UserEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        db = new Database(new AsyncResponse() {
            ...
            public void resultHandler(Map<String, Object> result, int resultCode) {
                ...
                if (resultCode == 0) {
                    ...
                    db.filterWithOneFieldAndCompareLess("tickets", "userId", mAuth.getUid(), "end", getTodayDate(),
                            Ticket.class, 1);
                } else {
        ...
        db.filterWithOneFieldAndCompareGreater("tickets", "userId", mAuth.getUid(), "end", getTodayDate(), Ticket.class,
                0);
        return view;
    }
}